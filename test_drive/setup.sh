...
curl -L "http://s3.thinkaurelius.com/downloads/titan/titan-0.5.3-hadoop2.zip" -o "$TEST_DRIVE_DIR/titan-0.5.3-hadoop2.zip"

unzip -o "$TEST_DRIVE_DIR/titan-0.5.3-hadoop2.zip" -d "$TEST_DRIVE_DIR"

export GREMTHON_JAR_DIRS="$TEST_DRIVE_DIR/titan-0.5.3-hadoop2/lib"
...
cp "$SCRIPT_DIR/rexster-test-drive.xml" "$TEST_DRIVE_DIR/titan-0.5.3-hadoop2/conf/rexster-cassandra-es.xml"
